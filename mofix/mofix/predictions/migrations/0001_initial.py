    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('engine', models.CharField(choices=[('A','Match'),('B','Player'),('C','Ranking'),('D','Simulation'),('NL','AI')], max_length=2)),
        ...
        migrations.AlterUniqueTogether(name='teamranking', unique_together={('user', 'name')}),
    ]
